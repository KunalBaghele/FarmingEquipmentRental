      ...
      <nav className="main-header navbar navbar-expand navbar-white navbar-light ">
        ...
        <ul className="navbar-nav">
          <li className="nav-item">
            <Link className="nav-link text-success" data-widget="pushmenu" to="#" role="button"><i className="fas fa-bars" /></Link>
          </li>
        </ul>
        <h5 className="text-center text-uppercase" style={{ width: '100%',color:'forestgreen',textShadow:'1px 2px 3px',fontFamily:'monospace',msTextAutospace:'1px'}}><strong>Farming Equipment Rental System</strong></h5>
        {/* Right navbar links */}
        <ul className="navbar-nav ml-auto">
          {/* Messages Dropdown Menu */}
          {/* Notifications Dropdown Menu */}
          <li className="nav-item">
            <Link className="nav-link text-danger" data-widget="fullscreen" to="#" role="button">
              <i className="fas fa-expand-arrows-alt" />
            </Link>
          </li>
          <li className="nav-item dropdown">
            <Link className="nav-link text-info" data-toggle="dropdown" to="#">
            ...
            <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <div className="dropdown-divider"/>
              <Link to="/Forgotpass" data-target="#changepwd" data-toggle="modal" className="dropdown-item">
