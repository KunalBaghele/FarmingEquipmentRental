...
const Details = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //   toast.error('Advance cannot be greater than billing amount',{Position:toast.POSITION.TOP_CENTER})
    //   return
    // }
    // if (
    //   booking.cardno === '' ||
    ...
    //   booking.expiry === ''
    // ) {
    //   toast.error('Please provide payment details',{position:toast.POSITION.TOP_CENTER})
    //   return
    // }
    axios
      ...
      .then((resp) => {
        ...
        history.push('/mybookings',{position:toast.POSITION.TOP_CENTER})
      })
      .catch((error) => {
        toast.error(error)
      })
...
{/* Payment form */}
              ...
              <>
                <h5 className='p-2 mt-4'>
                  ...
                  <Link to='/register'>register</Link> to booking Equipment
                </h5>
              </>
            )}
          </div>
