...
export default function BkDetails() {
  ...
  const loadData = () => {
    axios.get(BASE_URL + 'api/bookings/' + bid).then((resp) => {
      setData(resp.data)
      setfdata({ ...fdata, ['amount']: resp.data?.price - resp.data?.advance })
    })
                          ...
                          <form>
                            <div className='form-group'>
                              ...
                              <input
                                ...
                                name='amount'
                                readOnly
                                value={data?.variant?.price - data.advance}
                        ...
                        <div className='card-body p-2'>
                          ...
                          {pmts.map((x) => (
                            <div className='card shadow p-2 mb-2'>
                              ...
                              <p className='m-0'>Amount : ₹ {data?.advance}</p>
