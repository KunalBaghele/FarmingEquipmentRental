        ...
        <div className="container" style={{minHeight: '79vh'}}>
            ...
            <div className="col-sm-4 mx-auto text-center" style={{boxShadow: '0 0 2px 1px white'}}>
                ...
                <div className="card-body">
                    <img src='../../images/farmerpng.jpg' alt="Company Logo" style={{width: 150}} className="my-2 rounded-circle" />
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" required placeholder="User Email Id" name="userid" value={user.userid} onChange={handleInput}className="form-control" />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="input-group">
                    ...
                    <span style={{fontSize:'12px'}}>New User? <Link className="text-danger" to='/register'>Register</Link></span><br/>
                    <span style={{fontSize:'12px'}}><Link className="text-danger" to='/Forgotpass'>Forgot Password</Link></span>
                    </form>
                </div>
                </div>
            </div>
